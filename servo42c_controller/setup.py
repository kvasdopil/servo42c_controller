...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'launch'), ['launch/main.launch.py']),
        (os.path.join('share', package_name, 'config'), glob('config/*.yaml')),
        (os.path.join('share', package_name, 'config', 'moveit'), glob('config/moveit/*.yaml')),
        (os.path.join('share', package_name, 'config', 'moveit'), glob('config/moveit/*.srdf')),
    ...
    description='Servo42C Controller ROS2 package with MoveIt configuration',
    license='Apache-2.0',
